...
pos.words = scan('C:/Users/Anirban/Desktop/Books/Project/OSP/positive-words.txt', what='character', comment.char=';') 
neg.words = scan('C:/Users/Anirban/Desktop/Books/Project/OSP/negative-words.txt', what='character', comment.char=';')
